...
export const projects: Project[] = [
  ...
  {
    id: 7,
    title: "Kilat LMS - AI Learning Platform",
    description: "Learning Management System for AI education and prompt engineering courses",
    longDescription: "Comprehensive Learning Management System designed for AI and prompt engineering education. Features include interactive courses, AI prompt tutorials, hands-on exercises, progress tracking, student dashboards, and certification programs. Empowers students to master AI tools like ChatGPT, Claude, and other LLMs through structured learning paths.",
    image: "/images/projects/kilat.svg",
    technologies: ["Next.js", "React", "TypeScript", "Tailwind CSS", "LMS Features", "AI Integration"],
    category: "Web Development",
    githubUrl: "#",
